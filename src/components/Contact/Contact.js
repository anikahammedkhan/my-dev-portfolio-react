        ...
        <div className='contact-us block md:flex items-center justify-evenly p-4 md:p-0'>
            ...
            <div className='w-full md:w-1/3 lg:w-1/3 contact-form shadow-2xl'>
                <form action="#">
                    ...
                    <button type="submit" className="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-success sm:w-fit hover:bg-primary focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 mt-4">Send message</button>
                </form>
            </div>
        </div>
    );
