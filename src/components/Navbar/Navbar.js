...
const Navbar = () => {
  return (
    <div className="sticky top-0 z-10">
      <div className="navbar bg-base-100 shadow-lg rounded-md justify-between px-10 py-5">
        ...
        <div className="hidden md:hidden lg:block flex-none">
          <div className="navbar-item">
            ...
            <Link to="/techState" className="btn btn-ghost btn-sm rounded-btn">
              TechStack
            </Link>
        ...
        <div className="flex-none block md:block lg:hidden">
          <div className="dropdown dropdown-end">
            ...
            >
              ...
              <li>
                <Link to="/techState">TechStack</Link>
              </li>
              <li>
